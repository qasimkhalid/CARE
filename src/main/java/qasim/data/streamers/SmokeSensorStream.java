...
//                            System.out.print("Smoke Observer Sleeps for " + observer_sleep + " at Time " + time_check_old + "\n");
                    ...
                    RdfQuadruple q = new RdfQuadruple(event_sequence, "http://www.ia.urjc.es/ontologies/building/sbevac_scenario#" + data[1], "\"" + data[2] + "\"^^http://www.w3.org/2001/XMLSchema#boolean", HumanTimeToMilliSeconds(data[0]));
